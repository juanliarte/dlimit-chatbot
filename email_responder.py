...
_TEMPLATES_FIXED = {
    "es": {
        ...
        "volume_note": "Aplicamos <strong>diferentes niveles de descuento</strong> según tu perfil: <strong>usuario final</strong>, <strong>revendedor</strong>, <strong>agencia</strong>, <strong>distribuidor</strong>, etc. Cuando Ester se ponga en contacto contigo te asignará el descuento general correspondiente. Para <strong>volúmenes especiales</strong> o configuraciones particulares hay además condiciones a medida que ajustamos caso por caso.",
    ...
    "en": {
        ...
        "volume_note": "We apply <strong>different discount levels</strong> depending on your customer profile: <strong>end user</strong>, <strong>reseller</strong>, <strong>agency</strong>, <strong>distributor</strong>, etc. When Ester contacts you, she will assign you the corresponding general discount. For <strong>special volumes</strong> or specific configurations we also adjust conditions case by case.",
    ...
    "fr": {
        ...
        "volume_note": "Nous appliquons <strong>différents niveaux de remise</strong> selon votre profil : <strong>utilisateur final</strong>, <strong>revendeur</strong>, <strong>agence</strong>, <strong>distributeur</strong>, etc. Lorsque Ester vous contactera, elle vous attribuera la remise générale correspondante. Pour <strong>les volumes importants</strong> ou configurations particulières, nous adaptons également les conditions au cas par cas.",
